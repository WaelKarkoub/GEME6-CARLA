...
class DDPG(object):
    def __init__(self, sess,state_size, action_size, actor_hidden_units=(300, 600),
        ...
        self._actor = Actor(tensorflow_session=sess,
                            state_size=state_size, action_size=action_size,
                            hidden_units=actor_hidden_units,
                            learning_rate=actor_learning_rate,
                            batch_size=batch_size, tau=tau)

        self._critic = Critic(tensorflow_session=sess,
                              state_size=state_size, action_size=action_size,
