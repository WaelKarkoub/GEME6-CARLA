from keras.layers import Dense, Input, merge, Add
...
class Critic(object):
    ...
    def _generate_model(self):
        ...
        """
        state_input_layer = Input(shape=[None,self._state_size])
        action_input_layer = Input(shape=[None,self._action_size])
        ...
        hidden = Dense(self._hidden[0], activation='linear')(s_layer)
        hidden = Add()([hidden, a_layer])
